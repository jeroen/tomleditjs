...
export function stringify(input) {
    ...
    let deferred2_1;
    try {
        const ret = wasm.stringify(input);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @param {string} path
 * @param {any} value
 * @param {IEditOptions | null} [options]
 * @returns {string}
 */
export function edit(input, path, value, options) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const ret = wasm.edit(ptr0, len0, ptr1, len1, value, isLikeNone(options) ? 0 : addToExternrefTable0(options));
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
